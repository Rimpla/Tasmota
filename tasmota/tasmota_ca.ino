...
const unsigned char TA0_DN[] PROGMEM = {
        ...
        0x6C, 0x31, 0x1B, 0x30, 0x19, 0x06, 0x03, 0x55, 0x04, 0x03, 0x0C, 0x12,
        0x48, 0x65, 0x69, 0x6D, 0x61, 0x74, 0x68, 0x61, 0x66, 0x65, 0x6E, 0x20,
        0x52, 0x6F, 0x6F, 0x74, 0x43, 0x41
};

const unsigned char TA0_RSA_N[] PROGMEM = {
        
};
